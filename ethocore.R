...
classes <- sort(classes[!classes %in% c('CLASS','RecordLevel')])
...
ethocore <- ethocore[order(ethocore$CLASS,ethocore$TERM),]
...
write.row <- function(x,header=FALSE) paste0('<tr>',x,'</tr>')
